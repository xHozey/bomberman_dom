...
export function GamePage() {
    return jsx(
        ...
        jsx('div', { className: 'content-container' },
            // Left Sidebar
            jsx('aside', { className: 'sidebar' },
                jsx('div', { className: 'sidebar-content' },
                    jsx('div', { className: 'sidebar-section lives-section' },
                    ...
                    jsx('div', { className: 'sidebar-section players-section', id: 'players', ref: Ref.playersRef }),
                    jsx('div', { className: 'sidebar-section status-section', ref: Ref.StatusRef },
